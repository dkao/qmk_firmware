...
#define RPG1 TO(_RPG1)
#define RPG2 MO(_RPG2)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_UTILITY] = LAYOUT_fix(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ENGRAM,                                       RPG1,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [_RPG1] = LAYOUT_fix(
        ...
        KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,                                         KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,
                 KC_LALT, KC_BSPC,                                                                          KC_LBRC, KC_RBRC,
                                   KC_ESC,  KC_SPC,                                       RPG2,    KC_ENT,
                                                     KC_1,    KC_3,     RETB,    KC_P,
                                                     KC_2,    KC_4,     KC_F8,   KC_F5
    ),
    ...
    [_RPG2] = LAYOUT_fix(
        ...
        _______, _______, _______, _______, _______,                                      KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
        _______, _______, _______, _______, _______,                                      KC_9,    KC_0,    KC_SCLN, KC_QUOT, KC_SLSH,
                 _______, _______,                                                                          KC_MINS, KC_EQL,
                                   _______, _______,                                      _______, _______,
                                                     KC_5,    KC_7,     _______, KC_GRV,
                                                     KC_6,    KC_8,     _______, _______
    ),
};
...
bool debounce(matrix_row_t raw[], matrix_row_t cooked[], uint8_t num_rows, bool changed) {
    ...
    bool use_eager = (IS_LAYER_ON(_SHMUP) || IS_LAYER_ON(_FPS1) || IS_LAYER_ON(_FPS2) || IS_LAYER_ON(_RPG1) || IS_LAYER_ON(_RPG2));
