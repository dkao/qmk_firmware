...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SHMUP] = LAYOUT_pretty(
    ...
    KC_ESC,   XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_RGHT,  XXXXXXX,                                                                   XXXXXXX,  KC_Z,     KC_X,     KC_C,     KC_V,     XXXXXXX,
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                                                                   XXXXXXX,  KC_A,     KC_S,     KC_D,     KC_F,     XXXXXXX,
              XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                                                                                       KC_Q,     KC_W,     KC_E,     KC_R,
                                                      XXXXXXX,  DEFAULT,                                               DEFAULT,  XXXXXXX,
                                                                XXXXXXX,                                               XXXXXXX,
                                            KC_UP,    KC_SPC,   XXXXXXX,                                               XXXXXXX,  KC_ENT,   KC_LSFT
  ),
