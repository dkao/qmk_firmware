...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_4x12(
        ...
        //KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, SHF_BSL,
        //KC_LALT, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
        ...
        //CW_TOGG, KC_F24, KC_LGUI, KC_LALT,  KC_SPC, MO(1),   MO(2),   KC_SPC, ALT_ENT, KC_BTN1, KC_BTN3, KC_BTN2
        //CW_TOGG, KC_F24, KC_LGUI, MO(1), SHF_SPC, KC_SPC,  KC_BSPC, SHF_ENT, MO(2), KC_BTN1, KC_BTN3, KC_BTN2
