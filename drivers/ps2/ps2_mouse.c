...
static inline void ps2_mouse_convert_report_to_hid(report_mouse_t *mouse_report) {
    ...
    uint8_t needs_left    = mouse_report->buttons & (1 << PS2_MOUSE_BTN_RIGHT);
    uint8_t needs_right   = mouse_report->buttons & (1 << PS2_MOUSE_BTN_LEFT);
    mouse_report->buttons = (mouse_report->buttons & ~((1 << PS2_MOUSE_BTN_LEFT) | (1 << PS2_MOUSE_BTN_RIGHT))) | (needs_left ? (1 << PS2_MOUSE_BTN_LEFT) : 0) | (needs_right ? (1 << PS2_MOUSE_BTN_RIGHT) : 0);
#endif
